...
const Myads = ({ navigation }) => {
    ...
    useEffect(() => {
        if (isLoggedIn) {
            ...
            db().collection('ads').where('Userid', '==', currentUser?.uid).onSnapshot((snapshot) => {
                ...
                <View style={styles.innerDetail}>
                    ...
                    <View style={styles.stats}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Image resizeMode={'contain'} source={require('../Assets/Images/eye.png')} style={{ width: 15, height: 15 }} />
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Image resizeMode={'contain'} source={require('../Assets/Images/heart.png')} style={{ width: 15, height: 15 }} />
